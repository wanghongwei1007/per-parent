...
public class TestColumn extends APITest {
    ...
    public void test001_POST() {
        String uri = getValue("column_post.uri");
        String payload = loadFile("column_add.json");
    ...
    public void test002_GETALL() {
        String uri = getValue("column_getall.uri");
    ...
    public void test003_GET() {
        ...
        String uri = String.format(getValue("column_get.uri"), id);
    ...
    public void test004_PUT() {
        Assert.assertNotNull(id);
        String uri = String.format(getValue("column_put.uri"), id);
        //format data
        String payload = String.format(loadFile("column_update.json"), id);
    ...
    public void test005_DELETE() {
        String uri = String.format(getValue("column_delete.uri"), id);
