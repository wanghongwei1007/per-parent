...
public class TestContent extends APITest {
    ...
    public void test001_POST() {
        String uri = getValue("content_post.uri");
        String payload = loadFile("content_add.json");
    ...
    public void test004_PUT() {
        Assert.assertNotNull(id);
        String uri = String.format(getValue("content_put.uri"), id);
        //format data
        String payload = String.format(loadFile("content_update.json"), id);
    ...
    public void test005_DELETE() {
        String uri = String.format(getValue("content_delete.uri"), id);
