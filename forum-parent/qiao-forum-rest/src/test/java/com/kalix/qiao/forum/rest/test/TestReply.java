...
public class TestReply extends APITest {
    ...
    public void test001_POST() {
        String uri = getValue("reply_post.uri");
        String payload = loadFile("reply_add.json");
    ...
    public void test002_GETALL() {
        String uri = getValue("reply_getall.uri");
    ...
    public void test003_GET() {
        ...
        String uri = String.format(getValue("reply_get.uri"), id);
    ...
    public void test004_PUT() {
        Assert.assertNotNull(id);
        String uri = String.format(getValue("reply_put.uri"), id);
        //format data
        String payload = String.format(loadFile("reply_update.json"), id);
    ...
    public void test005_DELETE() {
        String uri = String.format(getValue("reply_delete.uri"), id);
