package com.kalix.qiao.forum.rest.test;
...
public class TestForum extends APITest {
    ...
    public void test001_POST() {
        String uri = getValue("forum_post.uri");
        String payload = loadFile("forum_add.json");
    ...
    public void test002_GETALL() {
        String uri = getValue("forum_getall.uri");
    ...
    public void test003_GET() {
        ...
        String uri = String.format(getValue("forum_get.uri"), id);
    ...
    public void test004_PUT() {
        Assert.assertNotNull(id);
        String uri = String.format(getValue("forum_put.uri"), id);
        //format data
        String payload = String.format(loadFile("forum_update.json"), id);
    ...
    public void test005_DELETE() {
        String uri = String.format(getValue("forum_delete.uri"), id);
