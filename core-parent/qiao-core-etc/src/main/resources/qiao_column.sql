...
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (17,'家谱简介',2,4,'t','t','/news/genealogy');

INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (18,'家乡美',3,1,'t','t','/customs/hometown');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (19,'功德榜',3,2,'t','t','/customs/merit');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (20,'乔家风',3,3,'t','t','/customs/jiafeng');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (21,'地方志',3,4,'t','t','/customs/history');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (22,'家族活动年鉴',3,5,'t','t','/customs/yearbook');

INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (23,'谈谱',4,1,'t','t','/message/talk');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (24,'论亲',4,2,'t','t','/message/discuss');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (25,'寻根',4,3,'t','t','/message/seek');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (26,'史实辩考',4,4,'t','t','/message/facts');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (27,'专题讨论',4,5,'t','t','/message/special');

INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (28,'家谱格式',5,1,'t','t','/wiki/format');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (29,'罗列谱例',5,2,'t','t','/wiki/examples');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (30,'推介样谱',5,3,'t','t','/wiki/sample');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (31,'古谱的辨识',5,4,'t','t','/wiki/identification');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (32,'百科知识',5,5,'t','t','/wiki/knowledge');

INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (33,'家谱录入',6,1,'t','t','/compile/entry');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (34,'家谱管理',6,2,'t','t','/compile/management');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (35,'家谱查询',6,3,'t','t','/compile/inquire');
INSERT INTO qiao_cms_menu(id,name,columnId,sequence,message,show,url) VALUES (36,'家谱导出',6,4,'t','t','/compile/export');
