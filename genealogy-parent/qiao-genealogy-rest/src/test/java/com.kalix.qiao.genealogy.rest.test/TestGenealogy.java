package com.kalix.qiao.genealogy.rest.test;
...
public class TestGenealogy extends APITest {
    ...
    public void test001_POST() {
        String uri = getValue("genealogy_post.uri");
        String payload = loadFile("genealogy_add.json");
    ...
    public void test002_GETALL() {
        String uri = getValue("genealogy_getall.uri");
    ...
    public void test003_GET() {
        ...
        String uri = String.format(getValue("genealogy_get.uri"), id);
    ...
    public void test004_PUT() {
        Assert.assertNotNull(id);
        String uri = String.format(getValue("genealogy_put.uri"), id);
        //format data
        String payload = String.format(loadFile("genealogy_update.json"), id);
    ...
    public void test005_DELETE() {
        String uri = String.format(getValue("genealogy_delete.uri"), id);
