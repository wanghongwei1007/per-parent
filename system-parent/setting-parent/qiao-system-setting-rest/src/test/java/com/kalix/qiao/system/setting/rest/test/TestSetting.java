package com.kalix.qiao.system.setting.rest.test;
...
public class TestSetting extends APITest {
    ...
    public void test001_POST() {
        String uri = getValue("setting_post.uri");
        String payload = loadFile("setting_add.json");
    ...
    public void test002_GETALL() {
        String uri = getValue("setting_getall.uri");
    ...
    public void test003_GET() {
        ...
        String uri = String.format(getValue("setting_get.uri"), id);
    ...
    public void test004_PUT() {
        Assert.assertNotNull(id);
        String uri = String.format(getValue("setting_put.uri"), id);
        //format data
        String payload = String.format(loadFile("setting_update.json"), id);
    ...
    public void test005_DELETE() {
        String uri = String.format(getValue("setting_delete.uri"), id);
